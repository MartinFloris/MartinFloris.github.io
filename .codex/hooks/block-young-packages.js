 ...
 * in .codex/hooks.json), alongside block-dangerous-commands.js. It receives
 ...
 *
 * This duplicates .claude/hooks/block-young-packages.js on purpose: Claude
 * Code and Codex don't share a hook runtime. Keep the two in sync when
 * either changes.
 */
...
function fetchJson(url) {
  return new Promise((resolve, reject) => {
    const req = https.get(
      url,
      { timeout: 4000, headers: { "user-agent": "safety-hook-package-age-check" } },
      (res) => {
